...
//FORKED
static const unsigned int OLD_MIN_AGE = 10  * (60 * 60); // 10 min
static const unsigned int OLD_MAX_AGE = 1 * (60 * 60 * 24); // 1 day
static const unsigned int OLD_MOD_INTERVAL = 10  * (60 * 60); // time to elapse before new modifier is computed
static const unsigned int FORKED_MIN_AGE = 10 * (60); // 10 second
static const unsigned int FORKED_MAX_AGE = 1 * (60 * 60 ); // 1 min
static const unsigned int FORKED_MOD_INTERVAL = 5 * (60 * 60); // time to elapse before new modifier is computed
static const unsigned int FORKED_BLOCK_HEIGHT = 25000;
...
static const int64_t MAX_MONEY = 38254582 * COIN; // 
